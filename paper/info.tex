...
% TODO update the below to contain the specs of the new PC, somehow.
The numbers present in the tables below were computed on an x86\_64 ``Intel(R)
Core(TM) i7-8700 CPU @ 3.20GHz'' processor with 12 threads. For each column in
each table, the number of CPU hours taken to compute the largest value in that
...
\begin{table}[ht]
  ...
  \begin{tabular}{l|r|r|r|r}
    ...
    % tex-fmt: off
      ...
      8   & 20,054,643 (Dehn) & 1,639,905 & 764,329 & 84,961 \\
      \midrule
      $t$ & 2224        & 367       & 388     & 29
    % tex-fmt: on
  \end{tabular}
