...
% TODO(PR) can you please add references to the relevant OEIS sequences for
% the everything in the "among the algebraic structures" sentence?
...
% TODO(PR): update to say the same thing as the theorem above, also maybe don't
% use the term "equivalence" it's too non-specific.
...
% TODO(PR) maybe say how we actually compute these groups, I forget.
...
% TODO(PR): I don't think this is a good assumption to make, please remove it
% from what follows!
% Note that we take the convention that a ring has a multiplicative
% identity, although a semiring might not.

% TODO(PR): revise from here onwards to remove the weird names (as we discussed
% previously), and I think it will be enough to just list the tables with the
% relevant definition in the caption, i.e. no definitions required in this
% section.
